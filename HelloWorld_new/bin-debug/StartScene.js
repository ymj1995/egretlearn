...
var StartScene = (function (_super) {
    ...
    //  配置文件加载完成，开始加载资源组
    StartScene.prototype.onConfigComplete = function (event) {
        //  移除资源加载库的监听事件
    ...
    StartScene.prototype.onResourceLoadComplete = function (event) {
        //  移除监听事件和加载场景
    ...
    StartScene.prototype.onResourceLoadError = function (event) {
    };
    StartScene.prototype.onResourceLoadProgress = function (event) {
        if (event.groupName == "preload") {
    ...
    //  开始按钮回调
    StartScene.prototype.startBtnCallback = function (evt) {
        if (!this.canChoose) {
            return;
        }
    ...
    //  选择英雄按钮回调
    StartScene.prototype.heroBtnCallback = function (evt) {
        var stageW = this.stageW;
